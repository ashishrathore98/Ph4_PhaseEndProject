...
namespace PhaseEndProject.Controllers
{
    ...
    {
        private readonly PhaseEndAssesmentContext _context;

        public CustLogInfoesController(PhaseEndAssesmentContext context)
        {
            _context = context;
        }
        ...
        {
            var phaseEndAssesmentContext = _context.CustLogInfos.Include(c => c.User);
            return View(await phaseEndAssesmentContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PhaseEndAssesmentContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
